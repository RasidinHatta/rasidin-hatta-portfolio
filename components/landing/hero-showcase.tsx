      ...
      >
        <div className="mx-auto grid max-w-5xl items-center gap-10 px-6 py-24 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            <AnimatedText
              as="h1"
              className="text-2xl font-bold text-pretty whitespace-pre-line lg:text-4xl xl:text-5xl leading-tight dark:[-webkit-text-stroke:1px_theme('colors.background')] dark:text-foreground"
            >
              {/* Static Name */}
